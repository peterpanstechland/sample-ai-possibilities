...
1. hasBall=True and distOppGoal<=45: SHOOT aim CENTER power 1.0 immediately — never dribble to the byline; a hard shot beats a dribble every time. Only PASS to player 3 if completely blocked.
