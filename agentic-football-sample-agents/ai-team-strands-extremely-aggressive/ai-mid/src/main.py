...
2. hasBall=True and distOppGoal>45: MOVE_TO straight at the CENTER of the opponent goal (y=0), sprint true — then shoot next tick. Only PASS type THROUGH to 3 or 4 if you are surrounded. Never pass back.
3. Opponent has ball: PRESS_BALL intensity 1.0 or INTERCEPT aggressive true — press high.
4. Else: MOVE_TO advanced position in opponent half near forwards, sprint true.
